...
interface PublicationRepository {
    ...
    suspend fun confirmPreview(snapshot: ConfirmedPreviewSnapshot, forceOverwrite: Boolean = false): OutboxOperation
    ...
    suspend fun cancelOperation(operationId: UUID): Boolean
    suspend fun cancelAllForOrder(orderId: UUID)
}
